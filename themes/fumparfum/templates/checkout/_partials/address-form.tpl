...
{block name='form_fields' append}
  ...
  {if $type === "delivery"}
    <div class="form-group row">
      <div class="col-md-9 col-md-offset-3 custom-checkbox">
...
{block name='form_buttons'}
  {if !$form_has_continue_button}
    <button type="submit" class="btn btn-primary btn-block">{l s='Save' d='Shop.Theme.Actions'}</button>
  ...
  {else}
    <form>
      <button type="submit" class="continue btn btn-primary btn-block" name="confirm-addresses" value="1">
